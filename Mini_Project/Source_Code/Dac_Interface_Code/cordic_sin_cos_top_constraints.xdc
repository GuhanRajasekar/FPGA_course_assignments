...
#set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports NSYNC]
#set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports NSYNC]
#set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports SCLK]
#set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports SCLK]
#set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports SDATA1]
#set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports SDATA1]
#set_output_delay -clock [get_clocks clk] -min -add_delay 0.000 [get_ports SDATA2]
#set_output_delay -clock [get_clocks clk] -max -add_delay 0.000 [get_ports SDATA2]
