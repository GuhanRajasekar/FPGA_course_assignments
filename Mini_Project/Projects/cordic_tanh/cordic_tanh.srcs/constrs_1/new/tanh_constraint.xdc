...
set_output_delay -clock [get_clocks clk] -min -add_delay -1.000 [get_ports {tanh_res[*]}]
set_output_delay -clock [get_clocks clk] -max -add_delay 2.000 [get_ports {tanh_res[*]}]
